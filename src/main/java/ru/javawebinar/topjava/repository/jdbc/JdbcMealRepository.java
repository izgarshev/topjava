...
public class JdbcMealRepository implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        if (meal.isNew()) {
            ...
            meal.setId(id.intValue());
                ...
                "update meals set date_time=:dateTime, calories=:calories, description=:description" +
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query("select * from meals m where m.user_id=? and m.date_time<? and m.date_time>?", ROW_MAPPER, userId, endDateTime, startDateTime);
    }
}
